...
def create_feed_entry(fg: FeedGenerator, model: FreeModel, is_new: bool = True) -> None:
    ...
    if model.is_expired:
        summary_parts.append("<li><strong>⚠️ Expired:</strong> This model has an expiration date</li>")
...
def main() -> None:
    ...
    if not all_entries:
        ...
        entry.summary("No new free models or significant updates detected in this fetch.", type="text")
